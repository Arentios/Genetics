...
public class SequenceConstants {
	...
	public static final Integer NEEDLEMAN_WUNSCH_INDEL_DEFAULT = 0;
	
	public static final Integer SMITH_WATERMAN_MISMATCH_DEFAULT = -2;
	public static final Integer SMITH_WATERMAN_MATCH_DEFAULT = 1;
